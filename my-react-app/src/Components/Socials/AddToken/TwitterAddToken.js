...
/**
 *TwitterAddToken component for adding Twitter token.
 *
 * @param {Object} props - Component properties.
 * @param {Function} props.setParams - Function to set parameters in the parent component.
 * @returns {JSX.Element} - JSX element representing the TwitterAddToken component.
 */
export default function TwitterAddToken(props) {
